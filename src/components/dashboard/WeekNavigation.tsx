        ...
        <div className="text-center flex-1 min-w-0">
          <div className="flex items-center justify-center gap-2">
            ...
            {isCurrentWeekCompleted && (
              <span className="bg-emerald-500 text-white text-label-sm font-bold px-2 py-0.5 rounded-full flex items-center gap-1">
            ...
            {Array.from({ length: totalWeeks }, (_, i) => i + 1).map((week) => {
              ...
              return (
                <button
                  ...
                  disabled={!isUnlocked}
                  className={cn(
                    "w-6 h-6 rounded-full transition-all flex items-center justify-center text-label-sm font-bold",
